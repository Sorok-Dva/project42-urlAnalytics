...
router.get('/admin/subscription-plans', requireAdmin, adminController.listSubscriptionPlans)
router.post('/admin/subscription-plans', requireAdmin, adminController.createSubscriptionPlan)
router.patch('/admin/subscription-plans/:id', requireAdmin, adminController.updateSubscriptionPlan)
router.delete('/admin/subscription-plans/:id', requireAdmin, adminController.deleteSubscriptionPlan)
router.get('/admin/link-addons', requireAdmin, adminController.listLinkAddons)
router.post('/admin/link-addons', requireAdmin, adminController.createLinkAddon)
router.patch('/admin/link-addons/:id', requireAdmin, adminController.updateLinkAddon)
router.delete('/admin/link-addons/:id', requireAdmin, adminController.deleteLinkAddon)
...
router.get('/workspaces/plans', workspaceController.listPlans)
...
router.patch('/workspaces/:id/plan', workspaceController.selectPlan)
